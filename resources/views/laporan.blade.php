...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      ...
      <span class="brand-text font-weight-light">electric world</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./pengelolaan" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pengelolaan Data Pelanggan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./ivalidasi&verifikasi" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <!-- /.row -->
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Laporan Pembayaran Listrik</h3>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="masukan nama pengguna">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tarif</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="tarif">
                  </div>
                  <div class="form-group">
