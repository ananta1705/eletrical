        ...
        <!-- /.row -->
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Rekap Pembayaran Listrik</h3>
              ...
              <div class="card-footer clearfix">
                <a href="javascript:void(0)" class="btn btn-sm btn-info float-left">Hapus</a> <br></br>
                <a href="javascript:void(0)" class="btn btn-sm btn-info float-left">Edit</a> 
